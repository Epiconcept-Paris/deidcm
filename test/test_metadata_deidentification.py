...
class MetadataDeidentificationTest(unittest.TestCase):
    ...
    def test_regex(self):
        ...
        self.assertEqual(get_general_rule('0x50ffffff', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x50a23e56', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x50123456', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x60003000', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x60004000', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x60564000', self.recipe), 'RETIRER')
        self.assertEqual(get_general_rule('0x605d3000', self.recipe), 'RETIRER')
    ...
    def test_gen_uuid(self):
        ...
        for i in range(0, 9999):
            ...
            self.assertEqual(gen_dicom_uid(patient_id, guid, org_root="1.2.3.4"), new_hash)
    
    def test_levenshtein_distance(self):
        """test function for levenshtein_distance"""
        self.assertEqual(levenshtein_distance("chien","niche"), 4)
        self.assertEqual(levenshtein_distance("javawasneat","scalaisgreat"), 7)
