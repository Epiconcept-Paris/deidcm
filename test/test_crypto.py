...
class AdvancedTestSuite(unittest.TestCase):
  ...
  def test_keys_right_length(self):
    ...
    wkey128 = base64.decodebytes(generate_qr_key(f128, 128).encode("ASCII"))
    wkey256 = base64.decodebytes(generate_qr_key(f256, 256).encode("ASCII"))
    wkey512 = base64.decodebytes(generate_qr_key(f512, 512).encode("ASCII"))
    with self.subTest():
